...
### 🔧 Setup Guides
- [Firebase Setup](docs/setup/firebase-setup.md) - Authentication and Firestore configuration
- [Firebase Admin Setup](docs/setup/firebase-admin-setup.md) - Admin SDK for password reset
- [Custom OTP Setup](docs/setup/custom-otp-setup.md) - Gmail SMTP for OTP emails

### 📖 User Guides
- [Testing Guide](docs/guides/testing-guide.md) - Complete testing walkthrough
- [Preview Guide](docs/guides/preview-guide.md) - Feature walkthrough and demo scenarios
- [Troubleshooting](docs/guides/troubleshooting.md) - Common issues and solutions

### 🏗️ Architecture
- [Full Mock Flow](docs/architecture/full-mock-flow.md) - Interview system architecture
- [Phase 1 Summary](docs/architecture/phase1-summary.md) - Frontend completion overview
...
Follow the [Testing Guide](docs/guides/testing-guide.md) for comprehensive testing instructions covering:
...
If you encounter issues, check the [Troubleshooting Guide](docs/guides/troubleshooting.md) for:
